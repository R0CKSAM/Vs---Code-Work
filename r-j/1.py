...
CSV_PATH = Path(r"D:\Veto Logs Backup\Vs - Code Work\r-j\Book1.csv")
OUTPUT_PATH = Path(r"D:\Veto Logs Backup\Vs - Code Work\r-j\CTV FCT Dashboard.html")
STANDALONE_OUTPUT_PATH = Path(r"D:\Veto Logs Backup\Vs - Code Work\r-j\CTV FCT Dashboard Standalone.html")
EXCLUDED = [
    "ASTROLOGERS",
    "CHANNEL IMAGERY",
