...
OVERLAY_TEMPLATES = frozenset(('t5', 't11', 't14', 't15'))
    ...
    def bootstrap(self) -> Dict[str, Any]:
        return {
            ...
            "canvas_sizes": {
                ...
                **{key:list(self.core.BROADCAST_SIZES) for key in ('t10','t11','t12','t13','t15')},
            },
    ...
    def start_live(
        ...
        if clear_mode == 'chroma-magenta':
            if preset != 'HD 1080i50':
                raise ValueError('Magenta output requires HD 1080i50.')
